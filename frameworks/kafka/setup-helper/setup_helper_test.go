...
var listenerTests = []struct {
	...
	{ // Everything false
		...
		expectedListeners:           "listeners=PLAINTEXT://127.0.0.1:1000,EXTERNAL://127.0.0.1:29092",
	...
	{ // Kerberos enabled, no TLS
		...
		tlsAllowPlainEnvvarValue:    "false",
		extAdvListenerEnvvarValue:   "my.ext.load.balancer",
		expectedListeners:           "listeners=SASL_PLAINTEXT://127.0.0.1:1000,EXTERNAL://127.0.0.1:29092",
	...
	{ // Kerberos enabled, TLS enabled, No Plaintext
		...
		tlsAllowPlainEnvvarValue:    "false",
		expectedListeners:           "listeners=SASL_SSL://127.0.0.1:1001,EXTERNAL://127.0.0.1:29092",
	...
	{ // Kerberos enabled, TLS enabled, Plaintext allowed
		...
		expectedListeners:           "listeners=SASL_SSL://127.0.0.1:1001,EXTERNAL://127.0.0.1:29092,SASL_PLAINTEXT://127.0.0.1:1000,EXTERNAL2://127.0.0.1:29093",
	...
	{ // Kerberos disabled, TLS enabled, No plaintext
		...
		tlsEncryptionEnvvarValue:    "true",
		tlsAllowPlainEnvvarValue:    "false",
		expectedListeners:           "listeners=SSL://127.0.0.1:1001,EXTERNAL://127.0.0.1:29092",
	...
	{ // Kerberos disabled, TLS enabled, Plaintext allowed
		...
		tlsEncryptionEnvvarValue:    "true",
		tlsAllowPlainEnvvarValue:    "true",
		expectedListeners:           "listeners=SSL://127.0.0.1:1001,EXTERNAL://127.0.0.1:29092,PLAINTEXT://127.0.0.1:1000,EXTERNAL2://127.0.0.1:29093",
